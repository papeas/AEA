...
const translations = {
  en: {
    ...
    "plans.more": "See full plan details →",
    "plans.terms": "No monthly fee · optional service fee only if you need it · custom add-ons priced on request",
    "plans.cta": "Get started",
    "plans.basic.name": "Basic",
    "plans.basic.price": "from €400",
    ...
    "plans.premium.price": "€600–850",
    "plans.premium.tag": "A complete website, built around your brand.",
    "plans.premium.f1": "Up to 5 pages (one website), custom design",
  ...
  el: {
    ...
    "plans.more": "Δες όλες τις λεπτομέρειες →",
    "plans.terms": "Καμία μηνιαία συνδρομή · προαιρετική χρέωση υπηρεσίας μόνο αν χρειαστεί · custom πρόσθετα με χρέωση κατόπιν αιτήματος",
    "plans.cta": "Ξεκίνα",
    "plans.basic.name": "Basic",
    "plans.basic.price": "από €400",
    ...
    "plans.premium.f1": "Έως 5 σελίδες (ένα site), custom σχεδιασμός",
    ...
    "plans.ultra.name": "Ultra",
    "plans.ultra.price": "Κατόπιν συνεννόησης",
