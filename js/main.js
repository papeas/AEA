...
const translations = {
  en: {
    ...
    "plans.ultra.price": "from €1,600 + monthly fee",
  ...
  el: {
    ...
    "plans.ultra.name": "Ultra",
    "plans.ultra.price": "από €1.600 + μηνιαία συνδρομή",
