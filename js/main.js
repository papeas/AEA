...
const translations = {
  en: {
    ...
    "plans.terms": "No monthly fee with your own domain · hosting included free · custom add-ons priced on request",
  ...
  el: {
    ...
    "plans.terms": "Καμία μηνιαία συνδρομή με δικό σου domain · hosting δωρεάν · custom πρόσθετα με χρέωση κατόπιν αιτήματος",
    "plans.cta": "Ξεκίνα",
    "plans.basic.name": "Basic",
